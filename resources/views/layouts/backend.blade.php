...
<head>
  ...
  <title>Tranquera Abierta | Gestor de Contenidos</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo env('PATH_PUBLIC')?>" class="logo">
      ...
      <i class="fa fa-sun-o"></i> Tranquera Abierta</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Noticia/0"><i class="fa fa-newspaper-o"></i> Noticias</a></li> 
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Video/0"><i class="fa fa-youtube"></i> Videos</a></li>  
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Publicidad/6"><i class="fa fa-buysellads"></i> Publicidades</a></li>   
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Mercado/7"><i class="fa fa-dollar"></i> Mercados</a></li>   
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">   
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Ubicacion_de_publicidad/0"><i class="fa fa-buysellads"></i> Ubicaciones de Publicidad</a></li>  
